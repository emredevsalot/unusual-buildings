    ...
    <>
      ...
      >
        <div className="container">
          ...
          <motion.div variants={variantsOpacity({ delay: 2 })}>
            ...
            <div className="privacyPolicy__bottom">
              ...
              <p>
                This website and our electronic publications may contain links
                to other websites over which Company GmbH has no control.
                Company GmbH assumes no responsibility or liability whatsoever
                for the operation and content of such websites.
              </p>
              <br />
